...
VaeDb_longTermCacheDelete_args::~VaeDb_longTermCacheDelete_args() throw() {
}


uint32_t VaeDb_longTermCacheDelete_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VaeDb_longTermCacheDelete_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("VaeDb_longTermCacheDelete_args");
...
VaeDb_longTermCacheDelete_pargs::~VaeDb_longTermCacheDelete_pargs() throw() {
}


uint32_t VaeDb_longTermCacheDelete_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("VaeDb_longTermCacheDelete_pargs");
...
VaeDb_longTermCacheDelete_result::~VaeDb_longTermCacheDelete_result() throw() {
}


uint32_t VaeDb_longTermCacheDelete_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VaeDb_longTermCacheDelete_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("VaeDb_longTermCacheDelete_result");
...
VaeDb_longTermCacheDelete_presult::~VaeDb_longTermCacheDelete_presult() throw() {
}


uint32_t VaeDb_longTermCacheDelete_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
VaeDb_longTermCacheSweeperInfo_args::~VaeDb_longTermCacheSweeperInfo_args() throw() {
}


uint32_t VaeDb_longTermCacheSweeperInfo_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VaeDb_longTermCacheSweeperInfo_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("VaeDb_longTermCacheSweeperInfo_args");
...
VaeDb_longTermCacheSweeperInfo_pargs::~VaeDb_longTermCacheSweeperInfo_pargs() throw() {
}


uint32_t VaeDb_longTermCacheSweeperInfo_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  oprot->incrementRecursionDepth();
  xfer += oprot->writeStructBegin("VaeDb_longTermCacheSweeperInfo_pargs");
...
VaeDb_longTermCacheSweeperInfo_result::~VaeDb_longTermCacheSweeperInfo_result() throw() {
}


uint32_t VaeDb_longTermCacheSweeperInfo_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t VaeDb_longTermCacheSweeperInfo_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("VaeDb_longTermCacheSweeperInfo_result");
...
VaeDb_longTermCacheSweeperInfo_presult::~VaeDb_longTermCacheSweeperInfo_presult() throw() {
}


uint32_t VaeDb_longTermCacheSweeperInfo_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void VaeDbClient::longTermCacheDelete(const int32_t session_id, const std::string& key)
{
  send_longTermCacheDelete(session_id, key);
  recv_longTermCacheDelete();
}

void VaeDbClient::send_longTermCacheDelete(const int32_t session_id, const std::string& key)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("longTermCacheDelete", ::apache::thrift::protocol::T_CALL, cseqid);

  VaeDb_longTermCacheDelete_pargs args;
  args.session_id = &session_id;
  args.key = &key;
  args.write(oprot_);
...
void VaeDbClient::recv_longTermCacheDelete()
{
  ...
  if (fname.compare("longTermCacheDelete") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  VaeDb_longTermCacheDelete_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void VaeDbClient::longTermCacheSweeperInfo(VaeDbDataForContext& _return, const int32_t session_id)
{
  send_longTermCacheSweeperInfo(session_id);
  recv_longTermCacheSweeperInfo(_return);
}

void VaeDbClient::send_longTermCacheSweeperInfo(const int32_t session_id)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("longTermCacheSweeperInfo", ::apache::thrift::protocol::T_CALL, cseqid);

  VaeDb_longTermCacheSweeperInfo_pargs args;
  args.session_id = &session_id;
  args.write(oprot_);
...
void VaeDbClient::recv_longTermCacheSweeperInfo(VaeDbDataForContext& _return)
{
  ...
  if (fname.compare("longTermCacheSweeperInfo") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  VaeDb_longTermCacheSweeperInfo_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void VaeDbProcessor::process_longTermCacheDelete(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("VaeDb.longTermCacheDelete", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "VaeDb.longTermCacheDelete");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "VaeDb.longTermCacheDelete");
  }

  VaeDb_longTermCacheDelete_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "VaeDb.longTermCacheDelete", bytes);
  }

  VaeDb_longTermCacheDelete_result result;
  try {
    iface_->longTermCacheDelete(args.session_id, args.key);
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "VaeDb.longTermCacheDelete");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("longTermCacheDelete", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "VaeDb.longTermCacheDelete");
  }

  oprot->writeMessageBegin("longTermCacheDelete", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "VaeDb.longTermCacheDelete", bytes);
  }
}
...
void VaeDbProcessor::process_longTermCacheSweeperInfo(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("VaeDb.longTermCacheSweeperInfo", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "VaeDb.longTermCacheSweeperInfo");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "VaeDb.longTermCacheSweeperInfo");
  }

  VaeDb_longTermCacheSweeperInfo_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "VaeDb.longTermCacheSweeperInfo", bytes);
  }

  VaeDb_longTermCacheSweeperInfo_result result;
  try {
    iface_->longTermCacheSweeperInfo(result.success, args.session_id);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "VaeDb.longTermCacheSweeperInfo");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("longTermCacheSweeperInfo", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "VaeDb.longTermCacheSweeperInfo");
  }

  oprot->writeMessageBegin("longTermCacheSweeperInfo", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "VaeDb.longTermCacheSweeperInfo", bytes);
  }
}
